...
import tk.devmello.mellolib.math.misc.Equals;
import tk.devmello.mellolib.queuing.tasks.TaskQueue;
import tk.devmello.mellolib.util.java.ArrayUtils;
...
public class PointXYZ extends PointXY {
    ...
    public static PointXYZ parse(String string) {
        TaskQueue.logger.consoleLogInfo(StringUtils.format("parsing input <%s>", string));
        ...
        TaskQueue.logger.consoleLogInfo(StringUtils.format("parsed input <%s> to <%s>", string, new PointXYZ(x, y, z)));
